    ...
    return {
      ...
      compile:function(tElement){
        ...
        return function(scope, element,attrs,yaMap) {
          ...
          if(collectionOptions && collectionOptions.clusterIconContentLayout){
            collectionOptions.clusterIconContentLayout =
              templateLayoutFactory.get(collectionOptions.clusterIconContentLayout);
          }
